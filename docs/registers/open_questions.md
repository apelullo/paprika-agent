...
**Register.** Questions that survived a pass, each naming what it blocks. An answered
question gets a DECISIONS.md line and moves to Closed. Numbers are never reused.
