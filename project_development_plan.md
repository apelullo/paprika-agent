...
- Doc process v4 (pass 20260922, Pass A) — stages renumbered 1-7 with one version tag per stage; `DECISIONS.md` ledger (moved from SUMMARY); `docs/registers/` (deferred, open questions), `docs/_auxiliary/`, `docs/_inbox/`, `docs/_archive/`; `DOC_PROCESS.md` → `SOP.md`; CLAUDE.md session-start block + file classes; Pieces 4-5 folded into Piece 3; `HANDOFF.md` retired; 12 commits (C1-C10 plus two close-amendment commits); no code change (51 tests)
